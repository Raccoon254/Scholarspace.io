        ...
        <div class="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div class="flex text-black/80 flex-col md:flex-row items-center justify-between">
                <div class="mb-6 md:mb-0 md:w-1/2">
                    ...
                    <p class="text-lg text-black/50 mb-6">Have a question or need assistance? Our friendly support team
                        is here to help. Fill out the form below, and we'll get back to you as soon as possible.</p>
                    <form method="POST" action="{{ route('contact.submit') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="user_message" id='message' cols="30" rows="6"
                                      class="w-full textarea bg-white border border-gray-300 rounded-lg shadow-sm"
                                      required>
                        </textarea>
                ...
                <div class="md:w-1/2">
                    <img src="{{ asset('images/svg2.png') }}" alt="Contact Us"
